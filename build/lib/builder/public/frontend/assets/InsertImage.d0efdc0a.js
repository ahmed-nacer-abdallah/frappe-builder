...
function V(t, e, i, N, a, o) {
  ...
  return (
    ...
    c(
      ...
      null,
      [
        _(t.$slots, "default", y(w({ onClick: o.openDialog }))),
        n(
          p,
          {
                ...
                r(
                  "input",
                  {
                    ...
                    onChange:
                      e[0] ||
                      (e[0] = (...l) =>
                        o.onImageSelect && o.onImageSelect(...l)),
                    accept: "image/*",
                  },
                  null,
                  32
            ...
            actions: s(() => [
              n(
                g,
                {
                  variant: "solid",
                  onClick:
                    e[1] || (e[1] = (l) => o.addImage(a.addImageDialog.url)),
                },
                { default: s(() => [u(" Insert Image ")]), _: 1 }
              ),
              n(
                g,
                { onClick: o.reset },
...
export { F as default };
//# sourceMappingURL=InsertImage.d0efdc0a.js.map
